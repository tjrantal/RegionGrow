...
//	setBatchMode(true);
	...
	sourceDir = "C:\\MyTemp\\oma\\Timon\\tyo\\SubchondralPilot\\karsittut2\\"
	...
	function analyseFile(sourceDir,file){
			...
			//run("Seeded 3D Region GrowT2", "xlow=120 xhigh=130 ylow=180 yhigh=200 zlow=7 zhigh=9 secondgrow stdgrow ");
			run("Seeded 3D Region GrowT2", "xlow=120 xhigh=130 ylow=180 yhigh=200 zlow=7 zhigh=9 secondgrow growupdown stdgrow ");
			run("3D Viewer");
