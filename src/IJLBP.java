...
public class IJLBP implements PlugIn {
    ...
    public void run(String arg) {
		...
		byte[][] lbpImage = lbp.getLBP(data);
		IJ.log("Got variance Image");
		ImagePlus resultImage = NewImage.createByteImage("Variance Image",width,height,1, NewImage.FILL_BLACK);
		...
		resultImage.setDisplayRange(0, 17);
        resultImage.show();
    }
