...
macro "LookStudyAnalysis"{
	...
	function analyseFile(sourceDir,file,dumpDir,visualDump){
			...
			run("Seeded 3D Region Grow With LBP and seed searching with LBP", "pathtotemplate=C:/MyTemp/oma/Timon/tyo/SubchondralPilot/ijGrower/src/template/ templatefilename=master.raw templatemaskname=mask.raw width=290 height=200 maxdiff=1.5 secondgrow stdgrow lbplimit1=0.12 lbplimit2=0.12 greylimit1=1.5 greylimit2=2.5 gradientlimit1=1.5 gradientlimit2=1.25 result_dump_path="+dumpDir+file+".mat visual_result_path="+visualDump+file+".raw");
			/*
			run("3D Viewer");
