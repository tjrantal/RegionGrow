...
//	sourceDir = "C:\\MyTemp\\oma\\Timon\\tyo\\SubchondralPilot\\karsittu\\kh1\\"
	...
	function analyseFile(sourceDir,file){
			...
			run("Seeded 3D Region Grow With LBP", "xlow=169 xhigh=250 ylow=370 yhigh=390 zlow=9 zhigh=12 maxdiff=1.5 secondgrow stdgrow lbplimit1=0.12 lbplimit2=0.12 greylimit1=1.5 greylimit2=3.0 gradientlimit1=1.5 gradientlimit2=1.5");
			run("3D Viewer");
