...
macro "LookStudyAnalysis"{
	...
	dumpDir = "C:\\MyTemp\\oma\\Timon\\tyo\\SubchondralPilot\\matlabDump\\luruRe\\"
	visualDump = "C:\\MyTemp\\oma\\Timon\\tyo\\SubchondralPilot\\matlabDump\\ijLuruRe\\"
	
	sourceDir = "C:\\MyTemp\\oma\\Timon\\tyo\\SubchondralPilot\\karsittuLuruRe\\"
	dumpDir = "C:\\MyTemp\\oma\\Timon\\tyo\\SubchondralPilot\\matlabDump\\luruReRe\\"
	visualDump = "C:\\MyTemp\\oma\\Timon\\tyo\\SubchondralPilot\\matlabDump\\ijLuruReRe\\"
	...
	function analyseFile(sourceDir,file,dumpDir,visualDump){
			...
			run("Seeded 3D Region Grow With LBP", "xlow=210 xhigh=290 ylow=340 yhigh=360 zlow=8 zhigh=10 maxdiff=1.25 secondgrow stdgrow lbplimit1=0.12 lbplimit2=0.12 greylimit1=1.5 greylimit2=2.5 gradientlimit1=1.5 gradientlimit2=1.25 result_dump_path="+dumpDir+file+".mat visual_result_path="+visualDump+file+".raw");
			/*
			run("3D Viewer");
